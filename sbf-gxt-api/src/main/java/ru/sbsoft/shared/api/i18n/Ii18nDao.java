...
public interface Ii18nDao extends java.io.Serializable{
    ...
    public static final String I18N_PROTOCOL = "i18n://";
    public static final String I18N_VALUE_REGEXP = I18N_PROTOCOL + "([^\\?]+)(|\\?.+)$";
    public static final String I18N_LIBRARY_REGEXP = ".*library=([^&]+).*";
    public static final String I18N_LOCALE_REGEXP = ".*locale=([^&]+).*";
     ...
     * @return переведенную строку, если перевод найден, иначе - параметр key.
     */
    public String get(String locale, I18nSection library, String key, ILocalizedString... parameters);
