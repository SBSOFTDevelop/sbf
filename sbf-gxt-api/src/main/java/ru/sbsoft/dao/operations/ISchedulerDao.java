...
public interface ISchedulerDao {
     ...
     */
    public void changeSchedulerStatus(Long operationId, SchedulerStatus oldStatus, SchedulerStatus newStatus) throws OperationException, IllegalOperationStatusException;
     ...
     * @throws OperationException
     */
    public SchedulerStatus getSchedulerStatus(Long operationId) throws OperationException;
