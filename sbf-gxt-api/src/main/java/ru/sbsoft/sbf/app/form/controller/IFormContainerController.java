...
public interface IFormContainerController<MODEL>
    ...
    static class FormEvent extends DefaultEvent<IFormContainerController> {
    ...
    static class FormModelEvent<MODEL> extends FormEvent {
    ...
    public static class BeforeSetValueEvent<MODEL> extends FormModelEvent<MODEL> {
    ...
    public static class AfterSetValueEvent<MODEL> extends FormModelEvent<MODEL> {
    }
