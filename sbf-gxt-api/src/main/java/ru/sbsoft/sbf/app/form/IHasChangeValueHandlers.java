...
public interface IHasChangeValueHandlers<VALUE> {
     ...
     */
    public Registration addChangeValueHandler(IHandler<ChangeValueEvent<VALUE>> handler);

    public static class ChangeValueEvent<VALUE> extends DefaultEvent<IHasValue<VALUE>> {
