...
public abstract class FilterAdapter {
    ...
    public void build(Condition condition, Column column, FilterItem filterItem) {
        this.condition = condition;
        build(column, filterItem);
    }
    
    protected abstract void build(Column column, FilterItem filterItem);

    public void buildModifiers(Condition condition, Column column, FilterItem filterItem) {
        this.condition = condition;
        buildModifiers(column, filterItem);
    }

    protected void buildModifiers(Column column, FilterItem filterItem) {
    }
