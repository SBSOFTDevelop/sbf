...
//    }
    ...
    protected void initTools() {
        ...
        addToolBt(ToolButton.REFRESH, new TreeAction(SBFGeneralStr.refresh, SBFResources.BROWSER_ICONS.Refresh16(), SBFResources.BROWSER_ICONS.Refresh()) {
            @Override
        ...
        addToolBt(ToolButton.EXPAND, new TreeAction(SBFGeneralStr.expandAll, SBFResources.BROWSER_ICONS.ExpandAll16(), SBFResources.BROWSER_ICONS.ExpandAll()) {
            @Override
            protected void onExecute() {
                getTree().expandAll();
            }
        ...
        addToolBt(ToolButton.COLLAPSE, new TreeAction(SBFGeneralStr.collapseAll, SBFResources.BROWSER_ICONS.CollapseAll16(), SBFResources.BROWSER_ICONS.CollapseAll()) {
            @Override
            protected void onExecute() {
                getTree().collapseAll();
            }
...
//                }
    ...
    protected abstract void loadTreeItems(TreeNode<K> parent, AsyncCallback<List<N>> callback);
