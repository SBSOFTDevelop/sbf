...
public class FSet<DataModel extends IFormModel> {
    ...
    private class ItemStore<DataModel extends IFormModel> {
    ...
    private class FieldItem<F extends Component> implements Item<IFormModel> {
    ...
    private class SimpleItem<DataModel extends IFormModel, H extends IFieldHandler & IFormFieldHandler<? super DataModel>> implements Item<DataModel> {
    ...
    private class ComposItem<DataModel extends IFormModel, H extends IFieldHandler & IFormFieldHandler<? super DataModel>> implements Item<DataModel> {
    ...
    private class BundleItem<DataModel extends IFormModel, H extends IFieldHandler & IFormFieldHandler<? super DataModel>> implements Item<DataModel> {
