...
class ColumnModelCreator {
    ...
    static ColumnModel<Row> create(List<ColumnConfig> csrc) {
        ...
        final Iterator<ColumnGroup> it = processed.keySet().iterator();
        while (it.hasNext()) {
            final ColumnGroup group = it.next();
    ...
    private static boolean isColumnInGroup(Column c, ColumnGroup group) {
