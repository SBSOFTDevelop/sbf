...
public abstract class BaseOperationProgressForm extends BaseWindow {
    ...
    private class LogGrid extends ContextGrid {
        ...
        @Override
        protected ColumnModel<Row> createColumnModel(Columns columns, boolean isMark) {
    ...
    private Component createLogComponent() {
        ...
        loggingBrowser = new FormGridView(loggingGrid, false, hasMenu(), new GridMode[]{GridMode.HIDE_INSERT, GridMode.HIDE_DELETE, GridMode.HIDE_UPDATE});
