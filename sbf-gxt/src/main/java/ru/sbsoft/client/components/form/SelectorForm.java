...
public class SelectorForm<E extends NamedItem> implements IMultiFormFactory<FormModel, Row> {
    ...
    protected class ChoiceForm<E extends NamedItem> extends GeneralParamForm {
        ...
        public ChoiceForm<E> cleanItems() {
            selectHandler.cleanItems();
            return this;
        }

        public ChoiceForm<E> addItems(Collection<E> es) {
            selectHandler.setNamedItems(es);
            return this;
        }

        public ChoiceForm<E> addItem(E e) {
