...
public class YearMonthDay implements Serializable, Comparable<YearMonthDay> {
    ...
    private static final int MIN_YEAR = YearMonth.MIN_YEAR;
    ...
    public YearMonthDay(YearMonth ym, int day) {
        this(ym.getYear(), ym.getMonth(), day);
    }
    ...
    public String getYmdStr() {
        StringBuilder buf = new StringBuilder(8).append(year);
        format(month, buf);
        format(day, buf);
        return buf.toString();
    }
