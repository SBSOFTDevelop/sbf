...
public interface IMultiOperationDao {
    ...
    Long createOperation(OperationType operationType, String locale, String currentModuleCode, boolean isNeedNotify) throws OperationException;
     ...
     */
    Long createOperation(OperationType operationType, String locale, String currentModuleCode) throws OperationException;
     ...
     * @throws NoSuchOperationCodeException если код операции не найден на сервере.
     */
    Long createOperation(OperationType operationType, String locale, String currentModuleCode, String username) throws OperationException;
...
//    public List<OperationInfo> listCurrentUserOperations(OperationsSelectFilter filter) throws OperationException;
    ...
    List<OperationInfo> listCurrentUserOperationsJdbc(OperationsSelectFilter filter) throws SQLException;
     ...
     */
    OperationInfo getOperationInfo(Long operationId) throws OperationException;
     ...
     * @throws OperationException
     */
    void setOperationParameters(Long operationId, List<OperationObject> parameters) throws OperationException;
     ...
     * @throws OperationException
     */
    void setOperationParameter(Long operationId, OperationObject parameter) throws OperationException;
     ...
     * @throws OperationException
     */
    List<OperationObject> getOperationParameters(Long operationId) throws OperationException;
     ...
     * @throws OperationException
     */
    OperationObject getOperationParameter(Long operationId, String name) throws OperationException;
     ...
     */
    void changeOperationStatus(Long operationId, MultiOperationStatus oldStatus, MultiOperationStatus newStatus) throws OperationException;
   ...
   // public void changeOperationStatus(Long operationId, MultiOperationStatus oldStatus, MultiOperationStatus newStatus, boolean isLock) throws OperationException, IllegalOperationStatusException;
     ...
     * @throws IllegalOperationStatusException если текущий статус операции не совпадает с параметром oldStatus.
     */
    void changeOperationStatus_SameTransaction(Long operationId, MultiOperationStatus oldStatus, MultiOperationStatus newStatus) throws OperationException;
     ...
     * @throws OperationException
     */
    MultiOperationStatus getOperationStatus(Long operationId) throws OperationException;
     ...
     * @throws OperationException
     */
    void writeLog(Long opertationId, OperationEvent event) throws OperationException;
     ...
     * @throws OperationException
     */
    void setOperationVisible(Long opertationId, boolean visible) throws OperationException;
     ...
     * @throws OperationException
     */
    String getOperationRunUser(Long operationId) throws OperationException;
...
//    public void startOperation(Long operationId) throws OperationException;
    ...
    void startOperation(Long operationId) throws OperationException;
     ...
     * @throws OperationException
     */
    void cancelOperation(Long operationId) throws OperationException;
     ...
     * @throws OperationException
     */
    void updateOperationProgress(Long operationId, BigDecimal progress, String comment) throws OperationException;
...
//
     ...
     * @throws OperationException
     */
    List<Long> listAllOpeartionsWithStatusJdbc(MultiOperationStatus status) throws OperationException;
//
//    /**
...
//    public List<Long> listOperationsToStartJdbc() throws OperationException;
     ...
     * @throws OperationException
     */
    List<OperationEvent> getOperationLog(Long operationId, Long lastLog) throws OperationException;
     ...
     * @throws OperationException
     */
    void setOperationNotified(Long operationId, Boolean notified) throws OperationException;
     ...
     * @throws OperationException
     */
    void setOperationNotify(Long operationId, Boolean notify) throws OperationException;

    Long createSynchOperation(OperationType operationType, String currentModuleCode, String username) throws OperationException;
}
