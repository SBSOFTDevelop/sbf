...
public enum Month implements NumeratedItem {
    ...
    Month(int num, I18nResourceInfo resourceInfo, I18nResourceInfo genResourceInfo) {
        checkMonthNum(num);
        this.num = num;
    ...
    public static int getQuarterNum(int monthNum) {
        return getYearPartNum(monthNum, 3);
    }

    public static int getHalfYearNum(int monthNum) {
        return getYearPartNum(monthNum, 6);
    }
    
    private static int getYearPartNum(int monthNum, int partSize){
        checkMonthNum(monthNum);
        return (int) ((monthNum - 1) / partSize) + 1;
    }
