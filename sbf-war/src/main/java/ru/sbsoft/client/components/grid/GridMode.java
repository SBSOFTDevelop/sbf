...
public enum GridMode {
    ...
    SINGLE_SELECTION, HIDE_SAVE, HIDE_INSERT, HIDE_UPDATE, HIDE_DELETE, FORCED_FILTER, HIDE_ONLYUPDATE, HIDE_MOVE, HIDE_FILTER, SHOW_GRID_RELOAD, ADD_CLONE, HIDE_REPORTS;
    //
