...
public class DualListHandler<M, F, T, SelfType extends DualListHandler<M, F, T, SelfType>> extends BaseHandler<DualListEditField<M, T>, List<M>, SelfType> {
    ...
    public SelfType useFromFilter() {
        getField().useFromFilter(true);
        return (SelfType) this;
    }

    public SelfType useFromFilter(ValueProvider<T, String> labelProvider) {
        getField().useFromFilter(labelProvider);
        return (SelfType) this;
    }
