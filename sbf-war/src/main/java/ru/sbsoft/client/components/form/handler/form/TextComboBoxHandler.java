 ...
 * @param <M>
 */
public class TextComboBoxHandler<M extends IFormModel> extends ru.sbsoft.client.components.form.handler.TextComboBoxHandler<TextComboBoxHandler<M>> implements IFormFieldHandler<M> {

    private final ValueProvider<? super M, String> valueProvider;

    public TextComboBoxHandler(String label, ValueProvider<? super M, String> valueProvider) {
        super(null, label);
