...
public abstract class AbstractHoldersListFactory<H extends HoldersList> {
    ...
    public H create(SystemGrid grid) {
        ...
        for (ColumnGroup g : groups.keySet()) {
        ...
        Collections.sort(hold, (o1, o2) -> {
            ...
            boolean ng1 = f1 != null && f1.getColumn().getColumn().getGroup() == null;
            boolean ng2 = f2 != null && f2.getColumn().getColumn().getGroup() == null;
            if (ng1 && !ng2) {
                return -1;
            } else if (ng2 && !ng1) {
                return 1;
