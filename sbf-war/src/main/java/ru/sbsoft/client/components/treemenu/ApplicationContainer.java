...
import ru.sbsoft.svc.state.client.StateManager;
...
/**
 * Главная панель приложения. Содержит главное меню и контейнер управляющий
 * открытием и отображением браузеров {@link BaseBrowserManager}. Управляет
 * также положением главного меню. Создается в
 * {@link ru.sbsoft.client.SBFEntryPoint} при инициализации приложения.
 *
 * @author balandin
...
public class ApplicationContainer extends BorderLayoutContainer {
    ...
    //
    private final MainMenuTree mainMenu;
    ...
    public ApplicationContainer(final BaseBrowserManager browserManager, final MainMenuTree mainMenu, final int menuAlign, final int menuWidth) {
        super();
