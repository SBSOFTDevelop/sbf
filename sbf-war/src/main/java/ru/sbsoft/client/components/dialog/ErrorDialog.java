...
import ru.sbsoft.svc.widget.core.client.container.VBoxLayoutContainer;
...
//    private static final IEMailServiceAsync EMAIL_RPC = SBFConst.EMAIL_SERVICE;
    ...
    public void show(ThrowableWrapper throwableWrapper) {
        show(null, throwableWrapper);
    }

    public void show(String msg, ThrowableWrapper throwableWrapper) {
        SafeHtmlBuilder b = new SafeHtmlBuilder();
        if(msg != null && !(msg = msg.trim()).isEmpty()){
            b.appendEscapedLines(msg);
        }
        b.appendHtmlConstant(throwableWrapper.generateTrace());
