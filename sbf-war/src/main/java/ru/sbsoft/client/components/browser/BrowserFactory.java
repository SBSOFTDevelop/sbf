...
public class BrowserFactory extends BaseBrowserFactory<BrowserFactory> implements IBrowserMaker {
    ...
    public FormGridView2<CommonGrid> createGridView(){
        FormGridView2<CommonGrid> v = new FormGridView2<>(createGrid(), getBrowserFlags());
        initBrowser(v);
        return v;
    }
    
    protected void initBrowser(Browser b){
