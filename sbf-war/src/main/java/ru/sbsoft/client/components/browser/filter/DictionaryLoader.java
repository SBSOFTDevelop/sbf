...
public class DictionaryLoader {
    ...
    private final Map<IColumn, LookupItemsList> loadedDictionaries = new HashMap<IColumn, LookupItemsList>();
    ...
    public void load(IColumn column, LookupSuccessHandler handler, String columnName) {
        load(column, handler, new DistinctValuesLoader(handler, column, columnName));
    }

    public void load(IColumn column, LookupSuccessHandler handler, LookupGridInfo lookupInfo) {
        load(column, handler, new CodebaseDictionaryLoader(handler, column, lookupInfo));
    }

    private void load(IColumn column, LookupSuccessHandler handler, DefaultLoader l) {
    ...
    private void complete(IColumn column, LookupSuccessHandler handler, LookupItemsList list) {
    ...
    public boolean checkCache(IColumn column, LookupSuccessHandler handler) {
    ...
    public abstract class DefaultLoader implements AsyncCallback<FetchResult<MarkModel>> {
        ...
        public DefaultLoader(LookupSuccessHandler successHandler, IColumn column, String loadMessage) {
            this.column = column;
    ...
    private class DistinctValuesLoader extends DefaultLoader {
        ...
        public DistinctValuesLoader(LookupSuccessHandler handler, IColumn column, String columnName) {
    ...
    private class CodebaseDictionaryLoader extends DefaultLoader {
        ...
        public CodebaseDictionaryLoader(LookupSuccessHandler handler, IColumn column, LookupGridInfo gridType) {
