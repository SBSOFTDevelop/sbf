 ...
 * @param <M>
 */
public class FileManagerHandler<M extends IFormModel> extends ru.sbsoft.client.components.form.handler.FileManagerHandler<FileManagerHandler<M>> implements IFormFieldHandler<M> {

    private final ValueProvider<? super M, String> valueProvider;

    public FileManagerHandler(String label, ValueProvider<? super M, String> valueProvider) {
        super(null, label);
