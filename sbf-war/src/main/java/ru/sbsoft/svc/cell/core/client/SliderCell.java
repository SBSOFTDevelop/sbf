...
import ru.sbsoft.svc.core.client.gestures.DragGestureRecognizer.CellDragGestureRecognizer;
...
import ru.sbsoft.svc.core.client.gestures.TapGestureRecognizer.CellTapGestureRecognizer;
...
import static ru.sbsoft.svc.core.client.gestures.PointerEvents.POINTERCANCEL;
import static ru.sbsoft.svc.core.client.gestures.PointerEvents.POINTERDOWN;
import static ru.sbsoft.svc.core.client.gestures.PointerEvents.POINTERMOVE;
import static ru.sbsoft.svc.core.client.gestures.PointerEvents.POINTERUP;
...
public class SliderCell extends FieldCell<Integer> {
   ...
   * <p/>
   * {@link ToolTipConfig#setAnchor(ru.sbsoft.svc.core.client.Style.Side)} is a required setting for toolTipConfig.
   *
