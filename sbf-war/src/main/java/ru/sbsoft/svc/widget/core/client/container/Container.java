...
import ru.sbsoft.svc.widget.core.client.HasItemId;
import ru.sbsoft.svc.widget.core.client.event.AddEvent;
import ru.sbsoft.svc.widget.core.client.event.AddEvent.AddHandler;
import ru.sbsoft.svc.widget.core.client.event.BeforeAddEvent;
import ru.sbsoft.svc.widget.core.client.event.BeforeAddEvent.BeforeAddHandler;
import ru.sbsoft.svc.widget.core.client.event.BeforeRemoveEvent;
import ru.sbsoft.svc.widget.core.client.event.BeforeRemoveEvent.BeforeRemoveHandler;
import ru.sbsoft.svc.widget.core.client.event.ContainerHandler;
import ru.sbsoft.svc.widget.core.client.event.ContainerHandler.HasContainerHandlers;
