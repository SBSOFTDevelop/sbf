...
import ru.sbsoft.svc.core.client.gestures.LongPressOrTapGestureRecognizer;
...
import ru.sbsoft.svc.data.shared.loader.ListLoadConfig;
import ru.sbsoft.svc.data.shared.loader.ListLoadResult;
...
import ru.sbsoft.svc.dnd.core.client.GridDragSource;
import ru.sbsoft.svc.dnd.core.client.GridDropTarget;
...
import ru.sbsoft.svc.widget.core.client.event.BodyScrollEvent.HasBodyScrollHandlers;
...
import ru.sbsoft.svc.widget.core.client.event.CellClickEvent.HasCellClickHandlers;
import ru.sbsoft.svc.widget.core.client.event.CellDoubleClickEvent;
import ru.sbsoft.svc.widget.core.client.event.CellDoubleClickEvent.CellDoubleClickHandler;
import ru.sbsoft.svc.widget.core.client.event.CellDoubleClickEvent.HasCellDoubleClickHandlers;
import ru.sbsoft.svc.widget.core.client.event.CellMouseDownEvent;
import ru.sbsoft.svc.widget.core.client.event.CellMouseDownEvent.CellMouseDownHandler;
import ru.sbsoft.svc.widget.core.client.event.CellMouseDownEvent.HasCellMouseDownHandlers;
import ru.sbsoft.svc.widget.core.client.event.HeaderClickEvent;
import ru.sbsoft.svc.widget.core.client.event.HeaderClickEvent.HasHeaderClickHandlers;
import ru.sbsoft.svc.widget.core.client.event.HeaderClickEvent.HeaderClickHandler;
import ru.sbsoft.svc.widget.core.client.event.HeaderContextMenuEvent;
import ru.sbsoft.svc.widget.core.client.event.HeaderContextMenuEvent.HasHeaderContextMenuHandlers;
import ru.sbsoft.svc.widget.core.client.event.HeaderContextMenuEvent.HeaderContextMenuHandler;
import ru.sbsoft.svc.widget.core.client.event.HeaderDoubleClickEvent;
import ru.sbsoft.svc.widget.core.client.event.HeaderDoubleClickEvent.HasHeaderDoubleClickHandlers;
import ru.sbsoft.svc.widget.core.client.event.HeaderDoubleClickEvent.HeaderDoubleClickHandler;
import ru.sbsoft.svc.widget.core.client.event.HeaderMouseDownEvent;
import ru.sbsoft.svc.widget.core.client.event.HeaderMouseDownEvent.HasHeaderMouseDownHandlers;
import ru.sbsoft.svc.widget.core.client.event.HeaderMouseDownEvent.HeaderMouseDownHandler;
import ru.sbsoft.svc.widget.core.client.event.ReconfigureEvent;
import ru.sbsoft.svc.widget.core.client.event.ReconfigureEvent.HasReconfigureHandlers;
...
import ru.sbsoft.svc.widget.core.client.event.RefreshEvent.HasRefreshHandlers;
import ru.sbsoft.svc.widget.core.client.event.RefreshEvent.RefreshHandler;
import ru.sbsoft.svc.widget.core.client.event.RowClickEvent;
import ru.sbsoft.svc.widget.core.client.event.RowClickEvent.HasRowClickHandlers;
import ru.sbsoft.svc.widget.core.client.event.RowClickEvent.RowClickHandler;
import ru.sbsoft.svc.widget.core.client.event.RowDoubleClickEvent;
import ru.sbsoft.svc.widget.core.client.event.RowDoubleClickEvent.HasRowDoubleClickHandlers;
import ru.sbsoft.svc.widget.core.client.event.RowDoubleClickEvent.RowDoubleClickHandler;
import ru.sbsoft.svc.widget.core.client.event.RowMouseDownEvent;
import ru.sbsoft.svc.widget.core.client.event.RowMouseDownEvent.HasRowMouseDownHandlers;
import ru.sbsoft.svc.widget.core.client.event.RowMouseDownEvent.RowMouseDownHandler;
import ru.sbsoft.svc.widget.core.client.event.SortChangeEvent;
import ru.sbsoft.svc.widget.core.client.event.SortChangeEvent.HasSortChangeHandlers;
import ru.sbsoft.svc.widget.core.client.event.SortChangeEvent.SortChangeHandler;
import ru.sbsoft.svc.widget.core.client.event.ViewReadyEvent;
import ru.sbsoft.svc.widget.core.client.event.ViewReadyEvent.HasViewReadyHandlers;
 ...
 * <p/>
 * In SVC, {@link ModelKeyProvider}s and {@link ValueProvider}s
 ...
 * Sbsoft supplied generator to create them for you automatically. A generator
 * runs at compile time to create a Java class that is compiled to JavaScript.
 * The Sbsoft supplied generator can create classes for interfaces that extend
 ...
 * SVC and you generally do not need to worry about what the class is called,
 ...
 * }</pre>
 * <p/>
 * To use the Sbsoft supplied generator to create model key providers and value
