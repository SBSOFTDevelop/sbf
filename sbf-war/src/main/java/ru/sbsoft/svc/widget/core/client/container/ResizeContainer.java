...
public abstract class ResizeContainer extends Container implements RequiresResize, ProvidesResize, HasLayout {
  ...
  /**
   * Measures the css margin width of the root element of the given widget.
   *
   * Deprecated as of 3.1.2, will be removed in a future version.
   * @param w widget to measure
   * @return the width of the margins on the left and right of the given widget
   */
  @Deprecated
