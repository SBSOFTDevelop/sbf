...
import ru.sbsoft.svc.widget.core.client.event.DialogHideEvent.DialogHideHandler;
import ru.sbsoft.svc.widget.core.client.event.DialogHideEvent.HasDialogHideHandlers;
