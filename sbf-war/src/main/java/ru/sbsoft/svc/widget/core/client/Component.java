...
import ru.sbsoft.svc.core.client.dom.DomIdProvider;
import ru.sbsoft.svc.core.client.dom.Layer;
import ru.sbsoft.svc.core.client.dom.Layer.ShadowPosition;
import ru.sbsoft.svc.core.client.dom.XElement;
import ru.sbsoft.svc.core.client.gestures.GestureRecognizer;
import ru.sbsoft.svc.core.client.gestures.HasGestureRecognizers;
...
import ru.sbsoft.svc.widget.core.client.event.BeforeHideEvent.HasBeforeHideHandlers;
import ru.sbsoft.svc.widget.core.client.event.BeforeShowContextMenuEvent;
import ru.sbsoft.svc.widget.core.client.event.BeforeShowContextMenuEvent.BeforeShowContextMenuHandler;
import ru.sbsoft.svc.widget.core.client.event.BeforeShowContextMenuEvent.HasBeforeShowContextMenuHandler;
import ru.sbsoft.svc.widget.core.client.event.BeforeShowEvent;
import ru.sbsoft.svc.widget.core.client.event.BeforeShowEvent.BeforeShowHandler;
import ru.sbsoft.svc.widget.core.client.event.BeforeShowEvent.HasBeforeShowHandlers;
...
import ru.sbsoft.svc.widget.core.client.event.BlurEvent.HasBlurHandlers;
import ru.sbsoft.svc.widget.core.client.event.DisableEvent;
import ru.sbsoft.svc.widget.core.client.event.DisableEvent.DisableHandler;
import ru.sbsoft.svc.widget.core.client.event.DisableEvent.HasDisableHandlers;
import ru.sbsoft.svc.widget.core.client.event.EnableEvent;
import ru.sbsoft.svc.widget.core.client.event.EnableEvent.EnableHandler;
import ru.sbsoft.svc.widget.core.client.event.EnableEvent.HasEnableHandlers;
...
import ru.sbsoft.svc.widget.core.client.event.FocusEvent.HasFocusHandlers;
import ru.sbsoft.svc.widget.core.client.event.HideEvent;
import ru.sbsoft.svc.widget.core.client.event.HideEvent.HasHideHandlers;
import ru.sbsoft.svc.widget.core.client.event.HideEvent.HideHandler;
import ru.sbsoft.svc.widget.core.client.event.MoveEvent;
import ru.sbsoft.svc.widget.core.client.event.MoveEvent.HasMoveHandlers;
import ru.sbsoft.svc.widget.core.client.event.MoveEvent.MoveHandler;
import ru.sbsoft.svc.widget.core.client.event.ShowContextMenuEvent;
import ru.sbsoft.svc.widget.core.client.event.ShowContextMenuEvent.HasShowContextMenuHandler;
import ru.sbsoft.svc.widget.core.client.event.ShowContextMenuEvent.ShowContextMenuHandler;
import ru.sbsoft.svc.widget.core.client.event.ShowEvent;
import ru.sbsoft.svc.widget.core.client.event.ShowEvent.HasShowHandlers;
...
import ru.sbsoft.svc.widget.core.client.tips.ToolTip;
import ru.sbsoft.svc.widget.core.client.tips.ToolTipConfig;

/**
 * Base class for all SVC widgets.
 */
