...
import ru.sbsoft.svc.widget.core.client.container.LayoutData;
...
import ru.sbsoft.svc.widget.core.client.event.MaximizeEvent.HasMaximizeHandlers;
...
import ru.sbsoft.svc.widget.core.client.event.MinimizeEvent.HasMinimizeHandlers;
import ru.sbsoft.svc.widget.core.client.event.MinimizeEvent.MinimizeHandler;
import ru.sbsoft.svc.widget.core.client.event.ResizeEndEvent;
import ru.sbsoft.svc.widget.core.client.event.ResizeEndEvent.ResizeEndHandler;
import ru.sbsoft.svc.widget.core.client.event.ResizeStartEvent;
import ru.sbsoft.svc.widget.core.client.event.ResizeStartEvent.ResizeStartHandler;
import ru.sbsoft.svc.widget.core.client.event.RestoreEvent;
import ru.sbsoft.svc.widget.core.client.event.RestoreEvent.HasRestoreHandlers;
 ...
 * w.setToolTip("The SVC product page...");
 * w.setWidget(new Frame("http://www.sbsoft.ru/products/sbf"));
 * w.show();
 * </pre>
 * <p/>
