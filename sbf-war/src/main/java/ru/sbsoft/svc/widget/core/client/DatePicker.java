...
import ru.sbsoft.svc.core.client.dom.CompositeFunction;
...
public class DatePicker extends Component implements HasValue<Date> {
   ...
   * applied when {@link #setDateTimeInfo(ru.sbsoft.svc.widget.core.client.DatePicker.DatePickerDateTimeFormatInfo)} is
   * called.
   */
  ...
  /**
   * Returns the date time messages used by the date picker. Changes to the returned instance (calling setters) will not be applied to the date picker until {@link #setDateTimeInfo(ru.sbsoft.svc.widget.core.client.DatePicker.DatePickerDateTimeFormatInfo)} is called.
   *
