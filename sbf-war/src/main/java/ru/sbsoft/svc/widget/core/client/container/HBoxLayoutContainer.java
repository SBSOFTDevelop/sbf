...
import ru.sbsoft.svc.widget.core.client.button.ButtonGroup;
...
import ru.sbsoft.svc.widget.core.client.event.OverflowEvent;
import ru.sbsoft.svc.widget.core.client.event.OverflowEvent.HasOverflowHandlers;
...
import ru.sbsoft.svc.widget.core.client.menu.HeaderMenuItem;
...
import ru.sbsoft.svc.widget.core.client.toolbar.FillToolItem;
...
public class HBoxLayoutContainer extends BoxLayoutContainer implements HasOverflowHandlers {
  ...
  protected void addWidgetToMenu(Menu menu, Widget w) {
    ...
    if (w instanceof SeparatorToolItem) {
      ...
      if (sb.getData("svc-menutext") != null) {
        item.setText(sb.getData("svc-menutext").toString());
      }
      if (sb.getMenu() != null) {
      ...
      if (b.getData("svc-menutext") != null) {
        item.setText(b.getData("svc-menutext").toString());
      }
      if (b.getMenu() != null) {
