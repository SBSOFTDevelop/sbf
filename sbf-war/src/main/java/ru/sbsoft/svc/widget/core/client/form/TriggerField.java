...
import ru.sbsoft.svc.cell.core.client.form.TriggerFieldCell;
import ru.sbsoft.svc.widget.core.client.event.TriggerClickEvent;
import ru.sbsoft.svc.widget.core.client.event.TriggerClickEvent.HasTriggerClickHandlers;
...
public abstract class TriggerField<T> extends ValueBaseField<T> implements HasTriggerClickHandlers {
  ...
  private native void setMimicking(TriggerFieldCell cell) /*-{
		cell.@ru.sbsoft.svc.cell.core.client.form.TriggerFieldCell::mimicking = false;
  }-*/;
