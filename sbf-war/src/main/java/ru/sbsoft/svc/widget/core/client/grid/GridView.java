...
import ru.sbsoft.svc.data.shared.Store.Record;
...
import ru.sbsoft.svc.widget.core.client.event.ColumnMoveEvent;
...
import ru.sbsoft.svc.widget.core.client.grid.ColumnHeader.HeaderContextMenuFactory;
...
public class  GridView<M> {
  ...
  public interface GridStateStyles extends CssResource {
     ...
     *
     * @see ru.sbsoft.svc.theme.base.client.grid.CheckBoxColumnDefaultAppearance
     * @see ru.sbsoft.svc.theme.base.client.grid.GroupingViewDefaultAppearance
     * @see ru.sbsoft.svc.theme.base.client.grid.RowExpanderDefaultAppearance
     */
    String rowSelected();
  ...
  protected void afterRender() {
    ...
    if (SVC.isSafari() || SVC.isChrome() || SVC.isIE()) {
      repaintGrid();
    }
  ...
  protected Menu createContextMenu(final int colIndex) {
    ...
    columns.setData("svc-columns", "true");
    ...
    for (int i = 0; i < cols; i++) {
      ...
      check.setData("svc-column-index", i);
  ...
  private void restrictMenu(ColumnModel<M> cm, Menu columns) {
    ...
    if (count == 1) {
      ...
      for (int i = 0, len = columns.getWidgetCount(); i < len; i++) {
        ...
        int col = item.getData("svc-column-index");
