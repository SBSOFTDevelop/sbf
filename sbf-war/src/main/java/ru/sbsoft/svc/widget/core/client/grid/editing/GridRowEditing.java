...
import ru.sbsoft.svc.widget.core.client.WidgetComponent;
import ru.sbsoft.svc.widget.core.client.button.ButtonBar;
...
import ru.sbsoft.svc.widget.core.client.form.error.HasErrorHandler;
import ru.sbsoft.svc.widget.core.client.form.error.TitleErrorHandler;
...
public class GridRowEditing<M> extends AbstractGridEditing<M> {
   ...
   * <li>Get the model with {@link ru.sbsoft.svc.widget.core.client.grid.Grid#getSelectionModel()}</li>
