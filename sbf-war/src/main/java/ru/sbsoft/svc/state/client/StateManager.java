 ...
 * your application initializes. By default, SVC initializes the StateManager with a CookieProvider. The provider can be
 * replaced as needed.
 * 
...
public abstract class StateManager {
  ...
  protected StateManager() {
    provider = new CookieProvider("/", null, null, SVC.isSecure());
  }
