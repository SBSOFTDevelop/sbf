...
package ru.sbsoft.svc.theme.gray.client.tools;
...
public class GrayTools extends Tools {

  public interface GrayToolResources extends ToolResources, ClientBundle {

    @Source("ru/sbsoft/svc/theme/base/client/tool/BaseTools.gss")
    ToolStyle style();
  ...
  public GrayTools() {
    super(GWT.<ToolResources> create(GrayToolResources.class));
  }
