 ...
 *   &lt;when-type-is class="ru.sbsoft.svc.core.client.dom.XDOM.XDOMImpl" />
 * &lt;/replace-with>
 * </pre></code>
 *
 * @see DOM
...
public class XDOM {
  ...
  public static native int getDocumentHeight()/*-{
		...
		return Math.max(scrollHeight,
				@ru.sbsoft.svc.core.client.dom.XDOM::getViewportHeight()());
  }-*/;
  ...
  public static native int getDocumentWidth()/*-{
		...
		return Math.max(scrollWidth,
				@ru.sbsoft.svc.core.client.dom.XDOM::getViewportWidth()());
  }-*/;
  ...
  public static native int getViewportHeight()/*-{
		if (@ru.sbsoft.svc.core.client.SVC::isIE()()) {
