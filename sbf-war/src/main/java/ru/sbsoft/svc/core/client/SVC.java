...
/**
 * SVC core utilities and functions.
 */
public class SVC {
  @PropertyName("svc.device")
  ...
  /**
   * URL to a 1x1 transparent GIF image used by SVC to create inline icons with
  ...
  /**
   * URL to a blank file used by SVC when in secure mode for iframe src to
  ...
  /**
   * Returns true if the browser uses shims. By default, SVC intelligently
