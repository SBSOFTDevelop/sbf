 ...
 * to the Ext instance is set $wnd.SVC.Ext.
 */
class Ext {
  ...
  native static void loadExt() /*-{
		...
		Ext = @ru.sbsoft.svc.core.client.dom.Ext::ext = {};
		...
		Ext.DomQuery = function() {
			...
			return {
				getStyle : function(el, name) {
					//return @ru.sbsoft.svc.ui.client.core.XElement::fly(Lcom/google/gwt/dom/client/Element;)(el).@ru.sbsoft.svc.ui.client.core.XElement::getStyle()(Ljava/lang/String;)(name);
					...
					if (styles) {
						if (typeof styles == "string") {
							...
							for ( var style in styles) {
								//@ru.sbsoft.svc.ui.client.core.XElement::as(Lcom/google/gwt/dom/client/Node;)(el).@ru.sbsoft.svc.ui.client.core.XElement::applyStyles(Ljava/lang/String;)(styles[style]);
							}
