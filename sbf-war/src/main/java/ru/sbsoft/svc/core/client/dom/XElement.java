...
import ru.sbsoft.svc.core.client.dom.impl.ComputedStyleImpl;
...
import ru.sbsoft.svc.core.client.util.Scroll;
  ...
  public final Size getStyleSize(boolean contentOnly) {
    ...
    if (map != null) {
      ...
      if (wid != null) {
        ...
        if (offsetWidth == 0 && isBorderBox && contentOnly && w != Style.DEFAULT && !SVC.isIE()) {
          w -= getFrameWidth(Side.LEFT, Side.RIGHT);
        } else if (SVC.isIE() && isBorderBox && w != Style.DEFAULT && contentOnly) {
          w -= getFrameWidth(Side.LEFT, Side.RIGHT);
      ...
      if (hei != null) {
        ...
        if (offsetHeight == 0 && isBorderBox && contentOnly && h != Style.DEFAULT && !SVC.isIE()) {
          h -= getFrameWidth(Side.TOP, Side.BOTTOM);
        } else if (SVC.isIE() && isBorderBox && h != Style.DEFAULT && contentOnly) {
          h -= getFrameWidth(Side.TOP, Side.BOTTOM);
